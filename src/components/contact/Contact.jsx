      ...
      <div className='bg-black pb-40 pt-20 xl:pb-[200px] xl:pt-[130px]'>
        ...
        <div className='global-container'>
          <div className='grid grid-cols-1 items-center gap-14 md:grid-cols-[minmax(0,_1fr)_1.4fr]'>
            ...
            >
              <img
                src='/public/assets/img/th-4/requestademo.png'
            ...
            >
              ...
              <div className='mb-6 md:max-w-max'>
                ...
                Join us at OrionAI and experience the future of business operations with our innovative
                AI solutions.
                </h4>
              </div>
              {/* Section Content Block */}
              <div className='text-left text-lg leading-[1.4] text-white lg:text-[21px]'>
                ...
                For more information or to request a demo, <Link to='/'>Contact Us</Link> .
                </p>
              </div>
              <ul className='mt-10 flex flex-col gap-6 font-dmSans text-[30px] tracking-[1.33] lg:mt-14 lg:gap-y-3 xl:mt-[70px]'>
                <li className='flex flex-col gap-x-2 leading-tight text-[#27b5c2] lg:flex-row lg:leading-normal'>
                  Email:
                  <a
                    href='mailto:yourmail@mail.com'
                    className='text-white hover:text-[#27b5c2]'
                  >
                    yourmail@mail.com
                  </a>
                </li>
