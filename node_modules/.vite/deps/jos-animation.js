      ...
      const _jos = class _jos {
        constructor() {
          ...
          __publicField(this, "callbackRouter_anchor", (t, s) => {
            ...
            document.querySelectorAll("[data-jos_anchor='#" + o.id + "']").forEach((t2) => {
              ...
              if (a.isIntersecting) {
                ...
                void 0 !== t2.dataset.jos_scrolldirection && "down" !== t2.dataset.jos_scrolldirection && "none" !== t2.dataset.jos_scrolldirection || (t2.classList.add("jos-" + o2), void 0 !== t2.dataset.jos_invoke_out && window[t2.dataset.jos_invoke_out](t2));
            });
          });
          ...
          __publicField(this, "callbackScroller", (t) => {
            if (this.disable || this.scrollProgressDisable)
              return;
...
`);
        ...
        debugger(t = 0) {
          if (0 === t && this.debugMode) {
            ...
            for (const s of Object.keys(this))
              "function" != typeof this[s] && (t2[s] = this[s]);
          ...
          let t = [], s = (a) => {
            ...
            if (a.classList.contains("jos_disabled") && (a.classList.remove("jos_disabled"), a.classList.add("jos")), o && ("true" == o || /^\d+$/.test(o)) ? a.setAttribute("data-jos_once", o) : a.setAttribute("data-jos_once", this.default_once ? "1" : "false"), a.dataset.jos_stagger) {
              ...
              if (a.id || (a.id = Math.random().toString(36).substring(7)), Array.from(a.children).forEach((c2, f) => {
                ...
                return void a.classList.remove("jos");
            }
        ...
        getStylesheet() {
          ...
          for (const t2 of this.setRange)
            s.insertRule(`[data-jos_duration="${t2}"] {
    ...
    transition-delay: ${t2}s !important;
        ...
        destroy(t = 0) {
          ...
          for (let t2 in this)
            this.hasOwnProperty(t2) && "function" != typeof this[t2] && (this[t2] = void 0);
